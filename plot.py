...
def plot_resonance_partitions_with_clustering(data, resonances, prev_threshold, threshold, output_file):
    """
    ...
    res_thr = [r for r in resonances if r.threshold == threshold and r.best_fit is not None]
